...
use App\Http\Controllers\sdk4php\src\OKMWebservice10;
use App\Http\Controllers\sdk4php\src\openkm\OKMWebservice10 as OpenkmOKMWebservice10;

/**
 * OKMWebservicesFactory
 *
 * @author sochoa
 */
class OKMWebServicesFactory {
    

    /**
     * OKMWebservice
     */
    public static function build($host, $username, $password) {        
        return new OpenkmOKMWebservice10($host, $username, $password);        
    }
