...
class UriHelper {
    ...
    const REPOSITORY_EXECUTE_SCRIPT = "services/rest/repository/executeScript";
    const REPOSITORY_EXECUTE_SQL_QUERY = "services/rest/repository/executeSqlQuery";
    const REPOSITORY_EXECUTE_HQL_QUERY = "services/rest/repository/executeHqlQuery";
